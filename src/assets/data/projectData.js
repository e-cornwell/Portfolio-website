...
const projectList = [
    ...
    },
    {
        ...
        description: "Designed as a Craigslist lite prototype, this frontend web application uses fetch API to consume a host API using CRUD (Create, Read, Update, Destroy) to write the functions nessesary to perform these intended actions.",
