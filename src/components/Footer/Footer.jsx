        ...
        <div className="sm:flex items-center justify-between md:gap-8">
          ...
          <div className="w-full sm:w-1/2">
            <p className="text-gray-300 leading-7 mt-4 sm:mt-0">
              ...
              praesentium atque assumenda maiores veniam? Molestias at quae aut
              officia veritatis!
            </p>
            ...
            <div className="hidden sm:block">
              <div className="flex items-center gap-[10px]">
                ...
                <div className="leading-[20px]">
                    <h2 className="text-gray-200 font-[500] text-[18px]">Quickbeam Studios</h2>
                </div>
              </div>
            </div>
            <div>
                <p className="text-gray-400 text-[14px]">Copyright {year} Quickbeam Studios - All rights reserved.</p>
                <p className="indent-{10px} text-gray-400 text-[14px]">Logo designed and created by Maya Cornwell - All rights reserved.</p>
            </div>
          </div>
        </div>
      </div>
